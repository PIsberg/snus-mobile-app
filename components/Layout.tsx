...
export const Layout: React.FC<LayoutProps> = ({ children, currentView, onChangeView }) => {
  return (
    <div className="flex flex-col h-screen bg-slate-900 text-white overflow-hidden max-w-md mx-auto shadow-2xl border-x border-slate-800">
      {/* Content Area */}
      ...
      <nav className="h-20 bg-slate-900/95 backdrop-blur-md border-t border-slate-800 flex items-center justify-around pb-4 pt-2 z-50">
        <button
          ...
          className={`flex flex-col items-center gap-1 transition-all duration-300 ${
            currentView === ViewState.HOME ? 'text-emerald-400 scale-110' : 'text-slate-500 hover:text-slate-300'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 transition-all duration-300 ${
            currentView === ViewState.STATS ? 'text-emerald-400 scale-110' : 'text-slate-500 hover:text-slate-300'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 transition-all duration-300 ${
            currentView === ViewState.SETTINGS ? 'text-emerald-400 scale-110' : 'text-slate-500 hover:text-slate-300'
          }`}
        >
